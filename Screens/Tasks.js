    ...
    >
      ...
      >
        <Entypo
          name="circle"
          size={26}
          color={changecolor ? "#DE5347" : "black"}
        />
      </TouchableOpacity>
...
const Taskscreen = () => {
  ...
  return (
    <View style={styles.boxOne}>
      ...
      <Menu style={{ width: 45, height: 32, alignSelf: "flex-end", top: 15 }}>
        <MenuTrigger>
          <Entypo name="dots-three-vertical" size={23} style={styles.icon3} />
        </MenuTrigger>
        <MenuOptions style={{height:190,}}>
          <MenuOption>
            <FlatList
              data={datalist}
      ...
      <ScrollView style={{ height: "50%", marginBottom: 145, top: 45 }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              <TouchableOpacity
                onPress={() => {
                  handeladd(), loadTextField(false), buttonLoad(true);
                }}
              >
                <MaterialCommunityIcons
